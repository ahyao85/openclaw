...
describe("runCodexAppServerAttempt", () => {
  ...
  it.each([
    ...
    { finalText: "The cleanup command failed, so the instructions are still saved.", expectedContext: false },
  ])("captures silent tool failures for finalization: $finalText", async ({ finalText, expectedContext }) => {
    ...
    await harness.notify(itemNotification("item/completed", {
      ...command,
      status: "failed",
