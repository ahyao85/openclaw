...
then reconnect the desktop. Each managed desktop owns a private PulseAudio server
...
unavailable. If private audio cannot start, desktop applications retain their
