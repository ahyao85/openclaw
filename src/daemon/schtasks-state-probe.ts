...
/** Changed facts cannot be downgraded to an unavailable initial observation. */
export class WindowsServiceObservationChangedError extends ServiceOwnershipRefusalError {
  constructor(message?: string) {
    super("windows-service-changed", message);
    this.name = "WindowsServiceObservationChangedError";
  }
}
